...
# Project:  Optim.pro
# Template: app
# Command: /lib/qt6/bin/qmake -o Makefile Optim.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
CXXFLAGS      = -pipe -D GUI -g -g -std=gnu++2a -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /lib/qt6/bin/qmake -install qinstall
QINSTALL_PROGRAM = /lib/qt6/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
LIBS          = $(SUBLIBS) /usr/lib/x86_64-linux-gnu/libQt6Widgets.so /usr/lib/x86_64-linux-gnu/libQt6Gui.so /usr/lib/x86_64-linux-gnu/libGLX.so /usr/lib/x86_64-linux-gnu/libOpenGL.so /usr/lib/x86_64-linux-gnu/libQt6Core.so -lpthread -lGLX -lOpenGL  -lncurses 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: Optim.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
...
ui_gui_optim.h: src/gui_optim.ui \
	...
	/usr/lib/qt6/libexec/uic src/gui_optim.ui -o ui_gui_optim.h

ui_settings.h: src/settings.ui \
		/usr/lib/qt6/libexec/uic
	/usr/lib/qt6/libexec/uic src/settings.ui -o ui_settings.h
