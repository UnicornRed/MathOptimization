...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MyGraphicsScene_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_MyGraphicsScene_t qt_meta_stringdata_MyGraphicsScene = {
    {
QT_MOC_LITERAL(0, 15), // "MyGraphicsScene"
QT_MOC_LITERAL(16, 22), // "signalTargetCoordinate"
QT_MOC_LITERAL(39, 0), // ""
QT_MOC_LITERAL(40, 5) // "point"

    },
    "MyGraphicsScene\0signalTargetCoordinate\0"
    "\0point"
};
...
void MyGraphicsScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signalTargetCoordinate((*reinterpret_cast< std::add_pointer_t<QPointF>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGraphicsScene::signalTargetCoordinate)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MyGraphicsScene::staticMetaObject = { {
    ...
    qt_meta_stringdata_MyGraphicsScene.offsetsAndSize,
    qt_meta_data_MyGraphicsScene,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MyGraphicsScene_t
, QtPrivate::TypeAndForceComplete<MyGraphicsScene, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QPointF, std::false_type>
...
// SIGNAL 0
void MyGraphicsScene::signalTargetCoordinate(QPointF _t1)
{
