...
# Project:  Optim.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile Optim.pro
#############################################################################
...
CXXFLAGS      = -pipe -O2 -std=c++20 -Wall -D DEBUG_DO -Wextra -D_REENTRANT -fPIC $(DEFINES)
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		src/Optimization.h \
		src/OptMethod.h \
		src/Point.h src/CursesOptim.cpp \
		src/GUI_Optim.cpp \
		src/MathFunc.cpp \
		src/Optim.cpp
QMAKE_TARGET  = Optim
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/CursesOptim.h src/DiffStoper.h src/MathFunc.h src/Optimization.h src/OptMethod.h src/Point.h $(DISTDIR)/
	$(COPY_FILE) --parents src/CursesOptim.cpp src/GUI_Optim.cpp src/MathFunc.cpp src/Optim.cpp $(DISTDIR)/
...
CursesOptim.o: src/CursesOptim.cpp src/DiffStoper.h \
		src/Optimization.h \
		src/Point.h \
		src/OptMethod.h \
		src/CursesOptim.h
...
MathFunc.o: src/MathFunc.cpp src/MathFunc.h \
		src/Optimization.h \
		src/Point.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MathFunc.o src/MathFunc.cpp

Optim.o: src/Optim.cpp src/CursesOptim.h \
		src/Point.h \
		src/Optimization.h \
		src/MathFunc.h \
		src/DiffStoper.h \
